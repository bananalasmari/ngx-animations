...
### Changed
- Bumped version to 1.0.8 after publishing 1.0.7 to npm.
...
### Changed
- Updated repository, bugs, and homepage URLs and bumped version to 1.0.7 for the latest npm release.
...
### Changed
- Updated npm package README to include the live Vercel demo link and clarify feature docs.
